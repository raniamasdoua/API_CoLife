...
public record CarpoolRequestDto(
        ...
        @NotBlank(message = "est obligatoire") String departureStreet,
        String departureComplement,
        @NotBlank(message = "est obligatoire") String departurePostalCode,
        @NotBlank(message = "est obligatoire") String departureCity
) {
}
